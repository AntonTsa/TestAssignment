...
public class UserFixture {
    ...
    public static final User USER_VALID_MODIFIED = User.builder()
            .id(1L)
            .email("Valid.email@gmail.com")
            .firstName("Firstname")
            .lastName("Lastname")
    ...
    public static final Page<User> USERS_PAGE_RESPONSE = new PageResponseTest<>(
    ...
    public static final Map<String, String> MODIFY_USER_REQUEST_VALID = Map.of(
            "email", "UserEmail1@gmail.com"
    );

    public static final Map<String, String> MODIFY_USER_REQUEST_INVALID = Map.of(
            "email", "Invalid Email"
    );

    public static final Map<String, String> MODIFY_USER_REQUEST_INVALID_AGE = Map.of(
            "birthDate", "2022-02-04"
    );

    // RETRIEVE USER REQUESTS
    public static final RetrieveUsersResponse<T> FIRST_RETRIEVE_USER_RESPONSE = RetrieveUsersResponse.builder()
            .id(2L)
            .email("USER1.email@gmail.com")
            .firstName("User1Firstname")
            .lastName("User1Lastname")
    ...
    public static final RetrieveUsersResponse<T> SECOND_RETRIEVE_USER_RESPONSE = RetrieveUsersResponse.builder()
            .id(3L)
            .email("Valid.email@gmail.com")
            .firstName("Firstname")
            .lastName("Lastname")
    ...
    public static final List<RetrieveUsersResponse<T>> RETRIEVE_USERS_RESPONSE = List.of(
            FIRST_RETRIEVE_USER_RESPONSE,
            SECOND_RETRIEVE_USER_RESPONSE
    );

    public static final PageResponseTest<RetrieveUsersResponse<T>> RETRIEVE_USERS_RESPONSE_PAGEABLE = new PageResponseTest<>(
            RETRIEVE_USERS_RESPONSE,
            PAGE_REQUEST
    );

    public static final PageResponseTest<RetrieveUsersResponse<T>> RETRIEVE_USERS_EMPTY_RESPONSE_PAGEABLE = new PageResponseTest<>(List.of(), PAGE_REQUEST);
